	...
	<div style="padding-left: 50px;">
		<form action="appoint" method="post" onsubmit="return validateForm()">
			<table style="margin-left: auto; margin-right: auto;">
                    <tr>
					<td><b><label for="AddClinic">Doctor:</label></b></td>
					<td><select name="addclinic" id="addclinic" required>
						<option>Please select</option>
						<option value ="Lifeline">Dr. Snehal (M.D. Physician)</option>
						<option value ="Silvercity">Dr. Suresh Balla (M.D.S. Dental)</option>
						<option value ="TataClinic">Dr. Ramesh N (Physiotherapist)</option>
						<option value ="MayoClinic">Dr. Abhishek Shelke (Surgeon)</option>
